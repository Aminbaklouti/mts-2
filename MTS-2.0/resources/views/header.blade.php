                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="/"><img class="header-logo" src="assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a onclick="scrollToSpeakers()">Speakers</a></li>
                                            <li><a onclick="scrollToSchedules()">Schedule</a></li>
