...
<main>
    <!--? slider Area Start-->
    <div id="dots-container" class="slider-area position-relative">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay=".1s">2nd edition</span>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                            <div class="single-caption mb-20">
                                ...
                                <div class="caption">
                                    <h5>Where</h5>
                                    <p>Diar Lemdina Hammamet Hotel - Nabeul - Tunisia</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/ivan_lopez.jpeg" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="https://www.linkedin.com/in/ivanlopezgimeno/"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Iván López Gimeno</a></h3>
                            <p> COO/CMO @Scoretize | #AI Prompt Engineer | #Web3 Marketer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/ramy_aldamati.jpeg" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="https://www.linkedin.com/in/ramyaldamati/"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Ramy AlDamati</a></h3>
                            <p> Serial W3bpreneur | Founder/Co-Founder | Startups & Ventures Builder | Mentor | CEO </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/achraf_saad.jpeg" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="https://www.linkedin.com/in/saadachraf/"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Achraf Saad</a></h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/soufiane_hajazi.jpeg" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="https://www.linkedin.com/in/soufiane-hajazi"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Soufiane Hajazi</a></h3>
                            <p> Backend Engineer | Solidity & Cairo Developer </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-6">
                    ...
                    <div class="section-tittle text-center mb-80">
                        ...
                        <p>3 Day schedule of the biggest metaverse event in the mena region.</p>
                    </div>
                </div>
            </div>
            <div class="row ">
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/firas_presenting.jpg);"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/girl_presenting.jpg);background-position: -206px 0px;background-size: 830px;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/guy_wearing_vr.jpg);"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/audience.jpg);background-position: 0 -70px;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/guy_talking.jpg);background-position: -132px 0px;background-size: 824px;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style="background-image: url(assets/img/gallery/audience_2.jpg);background-position: -191px 0px;background-size: 821px;"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>metaversetunisiasummit@gmail.com</h3>
